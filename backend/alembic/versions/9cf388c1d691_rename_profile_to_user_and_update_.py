...
Revision ID: 9cf388c1d691
Revises: 680a8f027c13
Create Date: 2025-05-18 20:32:56.577286
...
revision: str = '9cf388c1d691'
down_revision: Union[str, None] = '680a8f027c13'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'rosters', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    op.add_column('users', sa.Column('gamer_tag', sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('users', 'gamer_tag')
