...
export default function Admin(): React.ReactElement {
  ...
  return (
    <div className="main-content" style={{ color: '#f8fafc', background: 'transparent' }}>
      ...
      <Card>
        <div className="p-4">
          <h2 className="text-xl font-semibold mb-2">Team Approvals</h2>
          <p className="mb-4 text-sm text-[#94a3b8]">Review and approve team registrations</p>
      ...
      <div className="grid gap-6 md:grid-cols-2 my-8">
        <Card>
          <div className="p-4 space-y-4">
            <h2 className="text-xl font-semibold mb-2">League Settings</h2>
            <p className="mb-4 text-sm text-[#94a3b8]">Configure league parameters</p>
        ...
        <Card>
          <div className="p-4 space-y-4">
            ...
            <p className="mb-4 text-sm text-[#94a3b8]">Configure external integrations</p>
            <div className="space-y-2">
      ...
      <Card>
        <div className="p-4 space-y-4">
          <h2 className="text-xl font-semibold mb-2">Manual Stat Override</h2>
          <p className="mb-4 text-sm text-[#94a3b8]">Manually adjust player statistics</p>
      ...
      <Card>
        <div className="p-4 divide-y divide-[#0f172a]">
          ...
          <p className="mb-4 text-sm text-[#94a3b8]">Recent administrative actions</p>
          {[
